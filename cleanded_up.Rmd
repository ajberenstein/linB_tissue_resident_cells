...
qmin = 0.2
qmax = 0.9
res_folder = paste0("./results/","res",qmin,"_",qmax)
...
data.wt <- SCTransform(data.wt, method = "glmGamPoi", vars.to.regress = c("percent.mito","CC.Difference"), verbose = FALSE, variable.features.n = sct_nFeatures)
...
clean.classif[!clean.classif%in%categories_ok] <- ""
...
SFigSR
ggsave(paste0(plot_folder,"/SFigSR.pdf"),plot = SFigSR,width = 7, height = 7)
ggsave(paste0(plot_folder,"/SFigSR.png"),plot = SFigSR,width = 7, height = 7)
ggsave(paste0(plot_folder,"/SFigSR.tiff"),plot = SFigSR,width = 7, height = 7)
...
if(F){
  ...
  write.table(relation_ids_im,paste0(markers_folder,"/cluster_relation_ids_old_new_UMAPs.tsv"),quote = F)
  ...
  relation_ids_wt
  write.table(relation_ids_wt,paste0(markers_folder,"/wt_cluster_relation_ids_old_new_UMAPs.tsv"),quote = F)
}
```
...
```{r}
saveRDS(data.wt,file = paste0(dataset_folder,"/data.wt_sct200vf.rds"))
saveRDS(data.im,file = paste0(dataset_folder,"/data.im_sct200vf.rds"))
```
...
```{r,fig.height= 10,fig.width=7,warning=F, collapse =T,message =F}
...
```{r,eval = F}
ggsave(d,file = paste0(markers_folder,"/heatmap_fdr005.wt.png"),height = 20,width = 10, dpi = 300)
ggsave(d,file = paste0(markers_folder,"/heatmap_fdr005.wt.tiff"),height = 20,width = 10, dpi = 300)
ggsave(d,file = paste0(markers_folder,"/heatmap_fdr005.wt.pdf"),height = 20,width = 10,dpi = 300)
write.table(discrim.wt, file = paste0(markers_folder,"/markers_fdr005.wt.tsv"),sep = "\t",quote =F,row.names =F)

ggsave(e,file = paste0(markers_folder,"/heatmap_fdr005.im.png"),height = 20,width = 10,dpi = 300)
ggsave(e,file = paste0(markers_folder,"/heatmap_fdr005.im.tiff"),height = 20,width = 10,dpi = 300)
ggsave(e,file = paste0(markers_folder,"/heatmap_fdr005.im.pdf"),height = 20,width = 10,dpi = 300)
